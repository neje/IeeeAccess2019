...
public:
  ...
  RoutingTableEntry (Ptr<NetDevice> dev = 0,Ipv4Address dst = Ipv4Address (), bool vSeqNo = false, uint32_t seqNo = 0,
                     ...
                     Ipv4Address nextHop = Ipv4Address (), Time lifetime = Simulator::Now (), uint8_t etx = 0); /* etx */
...
private:
  ...
  */
  ...
  /// ETX metric field, since this field is 8b integer, 
  /// float value of etx is calcualted as 100*log10 (etx) 
  /// and then rounded and converted to uint8_t
  uint8_t m_etx; /*etx*/
};
